...
// ------------------------------------
std::shared_ptr<OptPeriodStringGenerator> FileNamer::createOptPeriodAsString(
  bool isOptimizationWeekly,
  unsigned int day,
  unsigned int week,
  unsigned int year)
{
...
std::string FileNamer::createCriterionFilename(
  const OptPeriodStringGenerator& optPeriodStringGenerator,
...
std::string FileNamer::createSolutionFilename(
  const OptPeriodStringGenerator& optPeriodStringGenerator,
  const unsigned int optNumber)
{
...
std::string FileNamer::createMarginalCostFilename(
  const OptPeriodStringGenerator& optPeriodStringGenerator,
  const unsigned int optNumber)
{
...
std::string FileNamer::createReducedCostFilename(
  const OptPeriodStringGenerator& optPeriodStringGenerator,
  const unsigned int optNumber)
{
...
std::string FileNamer::createModelerSolutionsFilename(
  const OptPeriodStringGenerator& optPeriodStringGenerator,
  const unsigned int optNumber)
{
